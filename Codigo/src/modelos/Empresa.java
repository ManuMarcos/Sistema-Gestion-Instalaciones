...
//	public void completarInstalacion(int idInstalacion, Calendar fechaInicio, Calendar fechaFinalizacion, boolean almorzo, int cantEvaporadoras, int cantKits, int cantCondensadoras) {
