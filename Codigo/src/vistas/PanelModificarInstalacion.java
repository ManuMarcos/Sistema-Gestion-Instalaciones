...
public class PanelModificarInstalacion extends Panel {
	...
	public PanelModificarInstalacion() {
		...
		JSpinner spinnerEvaporadora = new JSpinner();
		panelSeleccionarProductos.add(spinnerEvaporadora);
		...
		JSpinner spinnerCondensadora = new JSpinner();
		panelSeleccionarProductos.add(spinnerCondensadora);
		...
		JSpinner spinnerKitDeInstalacion = new JSpinner();
		panelSeleccionarProductos.add(spinnerKitDeInstalacion);
